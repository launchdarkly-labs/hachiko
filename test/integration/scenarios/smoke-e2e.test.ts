 ...
 */
async function simulateIssueEditHandler(sim: GitHubSimulator, issueNumber: number) {
 ...
 */
async function simulatePRClosedHandler(
  sim: GitHubSimulator,
  prNumber: number,
  prBranch: string,
  wasMerged: boolean,
...
function extractTotalSteps(docContent: string | null): number {
