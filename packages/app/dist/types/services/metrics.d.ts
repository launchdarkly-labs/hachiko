...
export declare class MetricsCollector {
     ...
     */
    recordMetric(name: string, type: MetricTypeType, value: number, tags?: Record<string, string>, metadata?: Record<string, unknown>): void;
    /**
     ...
     */
    recordStepExecution(planId: string, stepId: string, agentResult: AgentResult, policyViolations?: number): void;
    /**
