 ...
 */
export declare function executeMigrationStep(context: ContextWithRepository, planId: string, stepId: string, config: HachikoConfig, files: string[], prompt: string, chunk?: string): Promise<AgentResult>;
