...
export declare class ContainerExecutor {
     ...
     */
    createContainer(config: ContainerConfig, workspacePath: string, repoPath: string): Promise<ContainerContext>;
    /**
     * Execute a command inside a container
     */
    executeInContainer(context: ContainerContext, command: string[], timeout?: number): Promise<{
        exitCode: number;
        stdout: string;
        stderr: string;
     ...
     */
    executeCommand(command: string, args: string[], timeout?: number): Promise<{
        exitCode: number;
        stdout: string;
        stderr: string;
    }>;
