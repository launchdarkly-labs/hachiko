...
logger) {
    ...
    try {
        ...
        await (0, migrations_js_1.updateMigrationProgress)(context, planId, stepId, "completed", {
            prNumber: context.payload.pull_request.number,
            mergeCommit: context.payload.pull_request.merge_commit_sha,
            chunk,
        }, logger);
        // Emit repository dispatch for next step/chunk
        await (0, migrations_js_1.emitNextStep)(context, planId, stepId, chunk, logger);
    }
    catch (error) {
...
logger) {
    ...
    try {
        ...
        await (0, migrations_js_1.updateMigrationProgress)(context, planId, stepId, "skipped", {
            prNumber: context.payload.pull_request.number,
            chunk,
