...
const commands_js_1 = require("../services/commands.js");
const commands_js_2 = require("../utils/commands.js");
async function handleIssueComment(context, logger) {
    ...
    try {
        const command = (0, commands_js_2.parseHachikoCommand)(comment.body);
        if (!command) {
        ...
        switch (command.action) {
            case "rebase":
                await (0, commands_js_1.handleRebaseCommand)(context, command, logger);
                break;
            case "pause":
                await (0, commands_js_1.handlePauseCommand)(context, command, logger);
                break;
            case "resume":
                await (0, commands_js_1.handleResumeCommand)(context, command, logger);
                break;
            case "adopt":
                await (0, commands_js_1.handleAdoptCommand)(context, command, logger);
                break;
            case "status":
                await (0, commands_js_1.handleStatusCommand)(context, command, logger);
                break;
            case "skip":
                await (0, commands_js_1.handleSkipCommand)(context, command, logger);
                break;
            case "retry":
                await (0, commands_js_1.handleRetryCommand)(context, command, logger);
                break;
            default:
                await replyWithUsage(context, logger);
        }
