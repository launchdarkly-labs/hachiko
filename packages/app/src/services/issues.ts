 ...
 */
export async function createMigrationIssue(
 ...
 */
export async function createPlanReviewPR(
  context: ContextWithRepository,
  plan: MigrationPlan,
  config: HachikoConfig,
  logger: Logger
 ...
 */
function generatePlanReviewPRBody(original: MigrationPlan, _normalized: any): string {
 ...
 */
async function getLatestCommitSha(context: ContextWithRepository): Promise<string> {
