...
export class ContainerExecutor {
    ...
    async createContainer(config, workspacePath, repoPath) {
        ...
        try {
            ...
            throw new AgentExecutionError(`Failed to create container: ${error instanceof Error ? error.message : String(error)}`, "container");
        }
    }
    /**
    ...
    async executeInContainer(context, command, timeout = 300000 // 5 minutes default
        ...
        try {
            ...
            throw new AgentExecutionError(`Container execution failed: ${error instanceof Error ? error.message : String(error)}`, "container");
        }
    }
    /**
