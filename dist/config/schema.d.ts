...
>;
export declare const AgentConfigSchema: z.ZodUnion<
  [
    z.ZodObject<
      {
        kind: z.ZodLiteral<"cli">;
...
export declare const MigrationRollbackSchema: z.ZodDefault<
  z.ZodArray<
    z.ZodObject<
      {
        description: z.ZodString;
  ...
  >
>;
export declare const MigrationStatusSchema: z.ZodDefault<
  z.ZodEnum<
    [
      "draft",
      "plan-approved",
...
export declare function mergeConfigs(
  base: HachikoConfig,
  override: Partial<HachikoConfig>
): HachikoConfig;
