...
import { validateMigrationFrontmatter } from "../config/schema.js";
 ...
 */
export async function parsePlanFile(filePath) {
  const errors = [];
  try {
 ...
 */
export async function discoverPlans(repoRoot, config) {
 ...
 */
export async function loadAllPlans(repoRoot, config) {
 ...
 */
export function validatePlanDependencies(plans) {
  const errors = [];
 ...
 */
export function generateNormalizedFrontmatter(frontmatter, config) {
