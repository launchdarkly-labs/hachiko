 ...
 */
export async function updateMigrationProgress(context, planId, stepId, status, metadata, logger) {
 ...
 */
export async function emitNextStep(context, planId, completedStepId, chunk, logger) {
    logger?.info({ planId, completedStepId, chunk }, "Emitting next step");
    try {
        // TODO: Load plan to determine next step
        // For now, this is a placeholder implementation
        const payload = generateAgentDispatchPayload(planId, "next-step", // TODO: Calculate actual next step
