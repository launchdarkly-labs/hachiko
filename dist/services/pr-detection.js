 ...
 */
function extractMigrationIdFromBranchSuffix(suffix) {
 ...
 */
function normalizeMigrationId(branchId) {
...
export function validateHachikoPR(pr) {
    ...
    if (branchMigrationId) {
        ...
        recommendations.push(`Branch should include migration ID and step number (e.g., 'hachiko/{migration-id}-step-{n}' or '{agent}/{migration-id}-step-{n}')`);
    }
    // Check labels
