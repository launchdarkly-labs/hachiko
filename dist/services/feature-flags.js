...
export class FeatureFlagService {
    ...
    async initialize() {
        ...
        try {
            ...
            throw new ConfigurationError(`Feature flag service initialization failed: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
     ...
     */
    async isTestFlagEnabled(userId = "anonymous") {
        if (!this.initialized) {
     ...
     */
    async executeTestFlagOperation(userId = "anonymous") {
