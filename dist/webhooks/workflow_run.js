...
export async function handleWorkflowRun(context, logger) {
...
async function handleSuccessfulRun(context, workflowData, logger) {
    ...
    try {
        ...
        await updateMigrationProgress(context, planId, stepId, "awaiting-review", {
...
logger) {
    ...
    try {
        ...
        await updateMigrationProgress(context, planId, stepId, "failed", {
